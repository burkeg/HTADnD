...
public class Adventure {
	...
	List<DnDMonster> monsters = new ArrayList<DnDMonster>();
	...
	public void initializeAdventure() //Call to initialize an adventure after constructing
	{
		...
		{
			Chapter newChapter = new Chapter(playerCount, bosses, enemies, monsters);
	...
	{
		String tempStr;
		String[] bossInfo = new String[bosses.size()];
	...
	{
		String tempStr;
		String[] enemyInfo = new String[enemies.size()];
