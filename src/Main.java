...
public class Main {
	...
	public static RandomElements elements = new RandomElements(); // Global
																	// variable
																	// holding
																	// the
																	// Random
	...
	public static void main(String[] args) {
		...
		enemyCount = playerCount + 1
				+ (randNum(((playerCount / 2) * -1), (playerCount / 2))); // determines
																			// the
																			// amount
																			// of
																			// enemies
		...
		bossCount = playerCount / 2
				+ (randNum(((playerCount / 3) * -1), (playerCount / 3))); // determines
																			// the
																			// amount
																			// of
																			// boss
